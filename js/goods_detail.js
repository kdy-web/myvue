...
if(parseInt($('.goods_detail_right .goods_detail_inp').attr("value"))<=1){
	
		$('.goods_detail_right .goods_detail_down').attr("disabled")
	}
	
	
	$('.goods_detail_right .goods_detail_up').on('click',function(){
	...
	$('.goods_detail_right .goods_detail_down').on('click',function(){
